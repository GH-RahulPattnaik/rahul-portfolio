...
const projects = [
  {
    ...
    desc: 'Replicated 5 Shopify templates and a MyDukaan e-commerce website using Next.js, Tailwind CSS, and MongoDB — with full API support for realistic e-commerce functionalities.',
  ...
  },
  {
    ...
    type: 'Internship Project',
    desc: 'A fully responsive clone of Google Meet built with HTML, CSS, and JavaScript — seamless functionality across desktop and mobile.',
  ...
  },
  {
    ...
    desc: 'A responsive college notice board using HTML, CSS, and JavaScript — intuitive interface for managing and displaying announcements.',
            ...
            >
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.4rem', alignItems: 'flex-start' }}>
                  <h3 className="gs-display" style={{ fontSize: 'clamp(1.1rem, 3vw, 1.6rem)', fontWeight: 700, color: 'var(--text)', lineHeight: 1.1 }}>{p.title}</h3>
                  {p.featured && (
                    <span className="gs-mono" style={{ fontSize: '0.6rem', padding: '0.25rem 0.65rem', background: 'var(--accent)', color: '#fff', letterSpacing: '0.1em', textTransform: 'uppercase', flexShrink: 0 }}>Featured</span>
                  )}
                </div>
                <p className="gs-mono" style={{ fontSize: '0.65rem', color: 'var(--accent)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.65rem' }}>{p.type}</p>
                <p style={{ fontSize: '0.92rem', color: 'var(--text-muted)', lineHeight: 1.75, marginBottom: '1rem', maxWidth: '640px' }}>{p.desc}</p>
